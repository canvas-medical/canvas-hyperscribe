...
class InstructionWithParameters(Instruction):
    def __init__(self, uuid: str, instruction: str, information: str, is_new: bool, is_updated: bool, audits: list[str], parameters: dict):
        super().__init__(uuid, instruction, information, is_new, is_updated, audits)

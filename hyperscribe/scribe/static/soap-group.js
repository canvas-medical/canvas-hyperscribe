      ...
      <div class="section-body">
        ...
        ${sections.map(s => {
          ...
          if (key === 'current_medications') {
            ...
            // Split adHocs by type so each can be rendered through its own
            // amendment-aware row block (canvas-scribe pattern).
            const adHocMeds = adHocs.filter(e => e.command.command_type === 'medication_statement');
            const adHocStopMeds = adHocs.filter(e => e.command.command_type === 'stop_medication');

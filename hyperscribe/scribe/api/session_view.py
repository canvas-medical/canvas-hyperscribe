...
def _authorize_read(note_uuid: str, request: Any) -> JSONResponse | None:
    ...
    Distinct from :func:`_authorize_read_as_author` — that helper is for
    probe-defense endpoints (e.g. /verify-commands) where the caller is
    learning UUID existence and must be author-gated. This helper is for
    pure-display sync of state the surrounding chart already shows.

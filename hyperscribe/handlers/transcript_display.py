...
class TranscriptDisplay(SimpleAPIRoute):
    PATH = "/transcript"
    ...
    def get(self) -> list[Response | Effect]:
        ...
        if client_s3.is_ready() and (note_uuid := self.request.query_params.get("note_id")):
            ...
            store_path = f"hyperscribe-{canvas_instance}/transcripts/{note_uuid}/"
            url_list = [
        ...
        return [HTMLResponse(render_to_string("templates/transcript.html", context), status_code=HTTPStatus.OK)]

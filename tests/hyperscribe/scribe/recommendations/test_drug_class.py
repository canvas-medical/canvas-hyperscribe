...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("lisinopril 10 mg tablet", CHRONIC, 3),
        ("losartan 50 mg tablet", CHRONIC, 3),
        ("amlodipine 5 mg tablet", CHRONIC, 3),
        ("metoprolol succinate 25 mg tablet", CHRONIC, 3),
        ("hydrochlorothiazide 25 mg tablet", CHRONIC, 3),
        ("atorvastatin 20 mg tablet", CHRONIC, 3),
        ("rosuvastatin 10 mg tablet", CHRONIC, 3),
        ("sertraline 50 mg tablet", CHRONIC, 3),
        ("duloxetine 30 mg capsule", CHRONIC, 3),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("norvasc 5 mg tablet", CHRONIC, 3),
        ("lipitor 40 mg tablet", CHRONIC, 3),
        ("crestor 10 mg tablet", CHRONIC, 3),
        ("zoloft 50 mg tablet", CHRONIC, 3),
        ("cymbalta 30 mg capsule", CHRONIC, 3),

...
from hyperscribe.protocols.commander import CachedDiscussion, Audio, Commander
...
@patch("hyperscribe.protocols.commander.datetime", wraps=datetime)
...
@patch('hyperscribe.protocols.commander.LimitedCache')
@patch('hyperscribe.protocols.commander.AudioInterpreter')
@patch('hyperscribe.protocols.commander.CachedDiscussion')
@patch('hyperscribe.protocols.commander.Auditor')
...
@patch("hyperscribe.protocols.commander.time")
@patch.object(log, "info")

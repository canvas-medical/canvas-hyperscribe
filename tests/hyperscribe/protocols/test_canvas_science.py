...
from hyperscribe.protocols.structures.allergy_detail import AllergyDetail
from hyperscribe.protocols.structures.icd10_condition import Icd10Condition
from hyperscribe.protocols.structures.imaging_report import ImagingReport
from hyperscribe.protocols.structures.medical_concept import MedicalConcept
...
@patch('hyperscribe.protocols.canvas_science.log')
@patch('hyperscribe.protocols.canvas_science.requests_get')

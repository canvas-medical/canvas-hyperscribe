...
def test_exchange_summary(schema_summary, memory_log, helper, uuid4):
    ...
    for test in [False, True]:
        ...
        exp_content = [
            {
                ...
                'title': 'the_title_abcd1231',
            },
            {
                'summary': 'Some Summary 2',
                'title': 'the_title_abcd1232',
            },
        ]
        ...
        calls = [call.instance(tested.identification, 'detect_summary', tested.s3_credentials)]
        ...
        calls = [
            call.parent.__truediv__('summary_detection.json'),
            call.open('r'),
        ]

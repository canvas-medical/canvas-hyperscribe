...
def test_class():
    ...
    fields = {"host": str, "port": int, "user": str, "password": str, "database": str}
...
def test_from_dictionary():
    ...
    #
    result = tested.from_dictionary({})
    expected = PostgresCredentials(host="", port=0, user="", password="", database="")
    assert result == expected
...
def test_is_ready():
    ...
    arguments = {"host": "", "port": 0, "user": "", "password": "", "database": ""}

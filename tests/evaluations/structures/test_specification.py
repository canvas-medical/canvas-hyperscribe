    ...
    tests = [
        (
            ...
            ),
            {
                ...
                "clinicianStyle": "cautious and inquisitive",
                "patientStyle": "agreeable but vague",
                "bucket": "short",
            },
        ),
        (
...
def test_load_from_json():
    tests = [
        (
            {
                "turnTotal": 4,
                "speakerSequence": ["Patient", "Clinician", "Patient", "Clinician"],
                "ratio": 0.8,
                "mood": ["patient is embarrassed"],
                "pressure": "insurance denied prior authorization",
                "clinicianStyle": "over-explainer",
                "patientStyle": "assertive and informed",
                "bucket": "long",
            },
            Specification(
                turn_total=4,
        ...
        (
            {
                "turnTotal": 2,
                "speakerSequence": ["Clinician", "Patient"],
                "ratio": 1.0,

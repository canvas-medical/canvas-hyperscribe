...
from commander.protocols.launcher import HyperscribeLauncher
from tests.helper import is_constant


def test_class():
    tested = HyperscribeLauncher
...
@patch('commander.protocols.launcher.LaunchModalEffect')
def test_handle(launch_model_effect, note_db):
    ...
    tested = HyperscribeLauncher(event, secrets)
...
def test_visible():
    ...
    tested = HyperscribeLauncher(event)

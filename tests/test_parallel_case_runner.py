...
def test_run_single_case(time_mock, popen_mock):
    ...
    calls = [
        call([sys.executable, "case_runner.py", "--case", "test_case"],
             stdout=-1, stderr=-2, text=True, bufsize=1, universal_newlines=True)
    ]
    ...
    calls = [
        call([sys.executable, "case_runner.py", "--case", "test_case_cycles", "--cycles", "3"],
             stdout=-1, stderr=-2, text=True, bufsize=1, universal_newlines=True)
    ]
    assert popen_mock.mock_calls == calls
    calls = [call(), call()]
    ...
    calls = [
        call([sys.executable, "case_runner.py", "--case", "failed_case"],
             stdout=-1, stderr=-2, text=True, bufsize=1, universal_newlines=True)
    ]
    assert popen_mock.mock_calls == calls
    calls = [call(), call()]
    ...
    calls = [
        call([sys.executable, "case_runner.py", "--case", "exception_case"],
             stdout=-1, stderr=-2, text=True, bufsize=1, universal_newlines=True)
    ]
    assert popen_mock.mock_calls == calls
    calls = [call(), call()]
    ...
    calls = [
        call([sys.executable, "case_runner.py", "--case", "none_stdout_case"],
             stdout=-1, stderr=-2, text=True, bufsize=1, universal_newlines=True)
    ]
    assert popen_mock.mock_calls == calls
    calls = [call()]
    ...
    calls = [
        call([sys.executable, "case_runner.py", "--case", "empty_lines_case"],
             stdout=-1, stderr=-2, text=True, bufsize=1, universal_newlines=True)
    ]
    assert popen_mock.mock_calls == calls
    calls = [call(), call()]
...
def test_run_cases(thread_pool_mock, run_single_case_mock, capsys):
    ...
    calls = [
        call(tested.run_single_case, "case1"),
        call(tested.run_single_case, "case2")
    ]
...
def test_parse_arguments(argument_parser):
    ...
    calls = [
        ...
        call().add_argument("cycles", type=int, help="Split the transcript in as many cycles (passed to case_runner.py)"),

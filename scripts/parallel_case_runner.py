...
class ParallelCaseRunner:
    ...
    def run_cases(self, cases: list[str]) -> dict[str, bool]:
        ...
        with ThreadPoolExecutor(max_workers=self.max_workers) as executor:
            ...
            future_to_case = {executor.submit(self.run_single_case, case): case for case in cases}
    ...
    def parse_arguments(cls) -> Namespace:
        ...
        parser.add_argument("cases_number", type=int, help="Number of first N cases to run (sorted by database id)")
        parser.add_argument(
            "cycles",
            type=int,
